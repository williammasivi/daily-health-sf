...
export default function Sidebar() {
  ...
  return (
    ...
    //         </li>
    //         <li>
    //           <NavLink to="/auth/login" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
    ...
    //         </li>
    //         <li>
    //           <NavLink to="/auth/register" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
